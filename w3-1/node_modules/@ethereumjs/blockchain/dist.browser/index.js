            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.runWithLock(function () { return __awaiter(_this, void 0, void 0, function () {
                            var block, isGenesis, header, blockHash, blockNumber, td, currentTd, dbOps, valid, valid, checkpointSigners, activeSigners, _a, _b, _c, i, cSigner, _d, _e, parentTd, ancientHeaderNumber, ops, number, canonicalHeader;
                            var e_5, _f;
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    ...
                                    case 11:
                                        ...
                                        if (!(block.isGenesis() || td.gt(currentTd.header))) return [3 /*break*/, 16];
                                        if (!(this._common.consensusAlgorithm() === 'clique')) return [3 /*break*/, 13];
                                    ...
                                    case 18:
                                        _g.sent();
                                        if (!(this._common.consensusAlgorithm() === 'clique' && ancientHeaderNumber)) return [3 /*break*/, 24];
